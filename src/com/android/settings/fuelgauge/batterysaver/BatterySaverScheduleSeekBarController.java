...
public class BatterySaverScheduleSeekBarController
    ...
    public void updateSeekBar() {
        ...
        if (KEY_PERCENTAGE.equals(mode)) {
            ...
            final int currentSeekbarValue = Math.max(threshold / LEVEL_UNIT_SCALE, MIN_SEEKBAR_VALUE);
            mSeekBarPreference.setVisible(true);
            mSeekBarPreference.setProgress(currentSeekbarValue);
            final CharSequence stateDescription = formatStateDescription(currentSeekbarValue * LEVEL_UNIT_SCALE);
